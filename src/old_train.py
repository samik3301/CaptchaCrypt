...
def run_training():
    ...
    image_files = glob.glob("D:/Python/CaptchaCrypt/data/indiagov_captchas/*png")  #scanning through all the files within a folder
    ...
    torch.save(model.state_dict(), 'D:/Python/CaptchaCrypt/model_saves/indiagov_model2.bin') # From here one save model.state_dict NIBA not the entire model object
